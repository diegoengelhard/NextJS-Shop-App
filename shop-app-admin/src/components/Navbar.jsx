...
const Navbar = ({ showNavbar }) => {
    ...
    const activeLink = 'flex gap-1 p-1 bg-white text-black rounded-md'
    ...
    return (
        <>
            <aside className={(showNavbar ? 'left-0' : '-left-full') + 'text-white p-4 pr-0 h-full md:static md:w-auto transition-all '}>
                {/* Logo */}
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    {/* Settings link */}
                    <Link href={'/options'} className={pathname.includes('/options') ? activeLink : inactiveLink}>
